...
function Calendar({
  ...
  const defaultComponents = {
    Chevron: (componentProps: any) => {
      if (componentProps.orientation === "left") {
        return <ChevronLeft size={16} strokeWidth={2} {...componentProps} aria-hidden="true" />
      }
      return <ChevronRight size={16} strokeWidth={2} {...componentProps} aria-hidden="true" />
    },
  }
